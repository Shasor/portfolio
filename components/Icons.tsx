...
export const IconVariants = {
  ...
  linkedin: {
    ...
    icon: (props: ComponentPropsWithoutRef<"svg">) => (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M4.98 3.5C4.98 4.88 3.88 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1 4.98 2.12 4.98 3.5zM0 8h5v16H0V8zm7.5 0h4.7v2.2h.1c.7-1.2 2.3-2.5 4.8-2.5 5.1 0 6 3.3 6 7.6V24h-5v-7.1c0-1.7 0-3.9-2.4-3.9-2.4 0-2.7 1.9-2.7 3.8V24h-5V8z" />
      </svg>
    ),
  },
...
export function Icons({ name, className = "size-10" }: IconProps) {
  ...
  return (
    <Link href={href} target="_blank" className={cn(buttonVariants({ variant: "outline", size: "sm" }), className)}>
      <IconComponent className="size-fit" />
    </Link>
  );
}
